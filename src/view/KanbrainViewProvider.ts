...
<body>
  ...
  private css(): string {
    return `
      ...
      .kb-global-skill-option { width: 100%; flex-shrink: 0; text-align: left; padding: 6px 8px; background: var(--vscode-dropdown-background); border: none; border-radius: 4px; color: var(--vscode-dropdown-foreground); cursor: pointer; font-family: var(--vscode-font-family); font-size: 12px; white-space: nowrap; }
